...
export function CompanyPage({ onNavigate, onBack, user }) {
  const [activeTab, setActiveTab] = useState('ats'); // 'ats' | 'overview' | 'jobs'
  ...
  return (
    <div className="min-h-screen bg-[#f3f7f5] pb-16 font-sans text-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-2 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-900 text-xs font-bold">
            <ShieldCheck className="w-4 h-4 text-emerald-700" />
            <span>Verified Ayush Enterprise Portal</span>
          </span>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6 pt-2">
          ...
          <div className="px-6 sm:px-8 pb-6 pt-0 relative">
            ...
            <div className="flex flex-wrap items-center gap-2 pt-5 mt-4 border-t border-slate-100">
              ...
              >
                ...
                <span>Recruiter ATS &amp; Candidate Pipeline</span>
              </button>
              <button
              ...
              >
                ...
                <span>Active Job Listings ({profile.activeListings})</span>
              </button>
            </div>
        ...
        {/* Tab 2: Enterprise Overview & Certifications */}
        {activeTab === 'overview' && (
