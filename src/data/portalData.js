 ...
 * Exactly matches portal selection architecture and specifications.
 */
...
export const PORTALS_DATA = [
  ...
  },
  {
    ...
    buttonStyle: "bg-[#064e3b] text-white hover:bg-[#043d2e] shadow-sm", // Exact dark green button from screenshot
    demoUser: {
